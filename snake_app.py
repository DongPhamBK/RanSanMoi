...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, settings, show=True, fps=1000):                        ############# tốc độ rắn và có hiển thị đồ hoạ hay không ?
        super().__init__()
        ...
        # Xác định kích thước của gen tiếp theo dựa trên loại lựa chọn
    ...
    def update(self) -> None:
        ...
        # Cá nhân hiện tại đã chết
            ...
            # Next generation, giúp in ra tài liệu phục vụ cứu rắn khỏi bị chết
    ...
    def next_generation(self):
        ...
        # Tính toán năng lực của cá nhân rắn
        ...
        while len(next_pop) < self._next_gen_size:
            ...
            for l in range(1, L):
                ...
                # Crossover
                # @NOTE: Ta đang chọn để thực hiện cùng một loại chéo trên trọng lượng và sai lệch.
