...
class Population(object):
    ...
    @num_individuals.setter
    def num_individuals(self, val) -> None:
        raise Exception('Không thể thiết lập số lượng cá nhân. Thay vào đó, bạn phải thay đổi dân số.')
    ...
    @num_genes.setter
    def num_genes(self, val) -> None:
        raise Exception('Không thể thiết lập số lượng gen. Thay vào đó, bạn phải thay đổi Dân số.')
    ...
    @average_fitness.setter
    def average_fitness(self, val) -> None:
        raise Exception('Không thể thiết lập trí tuệ trung bình. Đây là một tài sản cố định.')
    ...
    @fittest_individual.setter
    def fittest_individual(self, val) -> None:
        raise Exception('Không thể thiết lập cá nhân mạnh nhất. Đây là một tài sản cố định')
