...
     @TODO: Phương trình liên kết
    ...
    # Tính toán con cái số 1 có nhiễm sắc thể (Eq. 9.9)
    chromosome1 = 0.5 * ((1 + gamma)*parent1 + (1 - gamma)*parent2)
    # Calculate Child 2 chromosome (Eq. 9.10),  Tính toán con cái số 2 có nhiễm sắc thể (Eq. 9.10)
